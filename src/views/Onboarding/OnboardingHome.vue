    ...
    <div class="onboading-home_tnc">
      ...
      >
        ...
        <p class="c0" id="h.1fob9te">
          ...
          <span class="c2">
            In order to use certain features of the Site and Services, you must connect to your
            digital asset wallet. &nbsp;You acknowledge that Company is not responsible for
            transferring, safeguarding, or maintaining your private keys or any digital currency
            associated therewith. &nbsp;If you lose, mishandle, or have stolen associated digital
            currency private keys, you acknowledge that you may not be able to recover associated
            digital currency, and that Company is not responsible for such loss. &nbsp; You agree to
            only enter into a swap transaction using bitcoin (BTC) or ether (ETH) in your custody
            that exists on a “testnet” blockchain. &nbsp;You agree not to initiate or complete a
            swap transaction using, or otherwise provide any digital currency that exists on, a
            “mainnet” blockchain or any digital currency that may be considered a security under
            applicable law. You acknowledge that Company is not responsible for any loss or damage
            arising from your failure to comply with the requirements hereunder.
          </span>
        </p>
        <p class="c0" id="h.1fob9te-1">
          <span class="c3"> 1.2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c3">Swap Amounts</span>
          <span class="c3">.</span>
          <span class="c2">
            &nbsp; You acknowledge that you may receive a lesser amount of BTC or ETH in your wallet
            following the swap transaction than displayed on the swap page as a result of a portion
            of such BTC or ETH being used to pay fees to miners.
          </span>
        </p>
        <p class="c0" id="h.1fob9te-1">
          <span class="c3"> 1.3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c3">Company Discretion</span>
          <span class="c3">.</span>
          <span class="c2">
            &nbsp; Company has sole discretion as to whether or not to enter into a swap transaction
            with you.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="2">
          <li class="c4 c13">
            <span class="c3 c17">ACCESS TO SITE AND SERVICES</span>
          </li>
        </ol>
        <p class="c0" id="h.3znysh7">
          <span class="c3"> 2.1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c3">License</span>
          <span class="c3">.</span>
          <span class="c2">
            &nbsp;Subject to these Terms, Company grants you a non-transferable, non-exclusive,
            revocable, limited license to use and access the Site and Services solely for your own
        ...
        <p class="c0" id="h.2et92p0">
          ...
          <span class="c2">
            The rights granted to you in these Terms are subject to the following restrictions: (a)
            you shall not license, sell, rent, lease, transfer, assign, distribute, host, or
            otherwise commercially exploit the Site or Services, whether in whole or in part, or any
            content displayed on the Site or Services; (b) you shall not modify, make derivative
            works of, disassemble, reverse compile or reverse engineer any part of the Site or
            Services; (c) you shall not access the Site or Services in order to build a similar or
            competitive website, product, or service; (d) except as expressly stated herein, no part
            of the Site or Services may be copied, reproduced, distributed, republished, downloaded,
            displayed, posted or transmitted in any form or by any means; and (e) you shall not use
            the Site or Services or enter into a swap transaction other than as permitted hereunder.
            &nbsp;Unless otherwise indicated, any future release, update, or other addition to
            functionality of the Site and Services shall be subject to these Terms. &nbsp;All
            copyright and other proprietary notices on the Site (or on any content displayed on the
            Site) must be retained on all copies thereof.
          </span>
        </p>
        <p class="c0" id="h.tyjcwt">
          <span class="c3"> 2.3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Modification. </span>
          <span class="c2">
            &nbsp; Company reserves the right, at any time, to modify, suspend, or discontinue the
            Site or Services (in whole or in part) with or without notice to you. &nbsp;You agree
            that Company will not be liable to you or to any third party for any modification,
            suspension, or discontinuation of the Site and Services or any part thereof.
          </span>
        </p>
        <p class="c0" id="h.3dy6vkm">
          <span class="c3">
        ...
        <p class="c0" id="h.1t3h5sf">
          <span class="c3 c17">
            2.5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ownership. &nbsp;
          </span>
          <span class="c2">
            Excluding any User Content that you may provide (defined below), you acknowledge that
            all the intellectual property rights, including copyrights, patents, trademarks, and
            trade secrets, in the Site and Services and its content are owned by Company or
            Company’s suppliers. &nbsp;Neither these Terms (nor your access to the Site and
            Services) transfers to you or any third party any rights, title or interest in or to
            such intellectual property rights, except for the limited access rights expressly set
            forth in Section ‎2.1. Company and its suppliers reserve all rights not granted in these
            Terms. &nbsp;There are no implied licenses granted under these Terms.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="3">
          <li class="c4 c13" id="h.4d34og8">
            <span class="c3 c17">USER CONTENT</span>
          </li>
        </ol>
        <p class="c0" id="h.2s8eyo1">
          <span class="c3"> 3.1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Content. </span>
          <span>&nbsp; “</span>
          <span class="c3">User Content</span>
          <span class="c2">
            ” means any and all information and content that a user submits to, or uses with, the
            Site and Services (e.g., content in the user’s profile or postings). &nbsp;You are
            solely responsible for your User Content. &nbsp;You assume all risks associated with use
            of your User Content, including any reliance on its accuracy, completeness or usefulness
            ...
            violate our Acceptable Use Policy (defined in Section ‎3.3). &nbsp;You may not represent
            or imply to others that your User Content is in any way provided, sponsored or endorsed
            by Company. &nbsp;Because you alone are responsible for your User Content, you may
            expose yourself to liability if, for example, your User Content violates the Acceptable
            Use Policy. &nbsp;Company is not obligated to backup any User Content, and your User
        ...
        <p class="c0">
          <span class="c3"> 3.2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c3">License.</span>
          <span>
            &nbsp; You hereby grant (and you represent and warrant that you have the right to grant)
            to Company an irrevocable, non-exclusive, royalty-free and fully paid, worldwide license
            ...
            grant sublicenses of the foregoing rights, solely for the purposes of including your
            User Content in the Site and Services. &nbsp;You hereby irrevocably waive (and agree to
            cause to be waived) any claims and assertions of moral rights or attribution with
            respect to your User Content.
          </span>
        </p>
        <p class="c4 c21" id="h.17dp8vu">
          <span class="c3 c17">
            3.3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acceptable Use Policy. &nbsp;
          </span>
          <span>The following terms constitute our “</span>
        ...
        <p class="c4 c8">
          ...
          <span>
            You agree not to use the Site and Services to collect, upload, transmit, display, or
            ...
            unlawful, harassing, abusive, tortious, threatening, harmful, invasive of another’s
            ...
            harm of any kind against any group or individual or is otherwise objectionable; (iii)
            that is harmful to minors in any way; or (iv) that is in violation of any law,
            regulation, or obligations or restrictions imposed by any third party or governmental
            agency, including without limitation securities laws, commodities laws, money
            transmission regulations, and anti-money laundering and anti-terrorism laws.
          </span>
        </p>
        <p class="c4 c8">
          ...
          <span class="c2">
            ...
            Site or Services any computer viruses, worms, or any software intended to damage or
            alter a computer system or data; (ii) send through the Site or Services unsolicited or
            ...
            otherwise; (iii) &nbsp;use the Site or Services to harvest, collect, gather or assemble
            ...
            connected to the Site or Services, or violate the regulations, policies or procedures of
            such networks; (v) attempt to gain unauthorized access to the Site or Services (or to
            other computer systems or networks connected to or used together with the Site or
            Services), whether through password mining or any other means; (vi) harass or interfere
            with any other user’s use and enjoyment of the Site or Services; or (vi) use software or
            automated agents or scripts to produce multiple accounts on the Site or Services, or to
            generate automated searches, requests, or queries to (or to strip, scrape, or mine data
            from) the Site or Services (provided, however, that we conditionally grant to the
            operators of public search engines revocable permission to use spiders to copy materials
            from the Site or Services for the sole purpose of and solely to the extent necessary for
            creating publicly available searchable indices of the materials, but not caches or
            archives of such materials, subject to the parameters set forth in our robots.txt file).
          </span>
        </p>
        <p class="c0" id="h.3rdcrjn">
          <span class="c3">
            3.4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enforcement. &nbsp;
          </span>
          <span class="c2">
            ...
            violate the Acceptable Use Policy or any other provision of these Terms or otherwise
            create liability for us or any other person. Such action may include removing or
            modifying your User Content, terminating your use, and/or reporting you to law
            enforcement authorities.
          </span>
        </p>
        <p class="c7 c18">
          <span class="c3"> 3.5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Feedback. </span>
          <span>
            &nbsp; Should you encounter any bugs, glitches, lack of functionality or other problems
            on the website, please let us know immediately so we can rectify these accordingly. We
            appreciate your feedback as it helps us develop the platform and offer the best Service
            possible. If you provide Company with any feedback or suggestions regarding the Site or
            Services (“
          </span>
          <span class="c3">Feedback</span>
          <span class="c2">
            ”), you hereby assign to Company all rights in such Feedback and agree that Company
            shall have the right to use and fully exploit such Feedback and related information in
            any manner it deems appropriate. &nbsp;Company will treat any Feedback you provide to
            Company as non-confidential and non-proprietary. &nbsp;You agree that you will not
            submit to Company any information or ideas that you consider to be confidential or
            proprietary.
          </span>
        </p>
        <p class="c7 c10">
        ...
        <p class="c0">
          ...
          <span class="c2">
            Company from time to time, in its sole discretion, may decide to offer prizes to
            incentivize user participation, however, any reward or benefit offered by Company does
            not create, constitute, or give rise to any legal or contractual rights in users of the
            Site and Services. You acknowledge that Company has no legal obligation to provide
            rewards to any contributor.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="4">
          <li class="c4 c13" id="h.26in1rg">
            <span class="c3">INDEMNIFICATION</span>
          </li>
        </ol>
        <p class="c4">
          <span class="c2">
            You agree to indemnify and hold Company (and its directors, officers, employees,
            contractors, affiliates, representatives and agents) harmless, including costs and
            attorneys’ fees, from any claim or demand made by any third party due to or arising out
            of (a) your use of the Site and Services, (b) your violation of these Terms, (c) your
            violation of applicable laws or regulations or (d) your User Content. &nbsp;Company
        ...
        <ol class="c12 lst-kix_list_1-0" start="5">
          <li class="c4 c13">
            <span class="c3 c17">THIRD PARTY LINKS</span>
            <span class="c3">&amp;</span>
            <span class="c3 c17">&nbsp;ADS; OTHER USERS</span>
          </li>
        </ol>
        <p class="c0">
          <span class="c3">
          ...
          <span>
            The Site and Services may contain links to third-party websites and services, including
            digital asset wallets, and/or display advertisements for third parties (collectively, “
          </span>
          <span class="c3">Third-Party Links &amp; Ads</span>
          <span class="c2">
            ”). &nbsp;Such Third-Party Links &amp; Ads are not under the control of Company, and
            Company is not responsible for any Third-Party Links &amp; Ads. &nbsp;Company provides
            access to these Third-Party Links &amp; Ads only as a convenience to you, and does not
            ...
            proceeding with any transaction in connection with such Third-Party Links &amp; Ads.
          </span>
        </p>
        <p class="c0">
          <span class="c3">
          ...
          <span class="c2">
            Each Site and Service user is solely responsible for any and all of its own User
            Content. &nbsp;Because we do not control User Content, you acknowledge and agree that we
            are not responsible for any User Content, whether provided by you or by others. &nbsp;We
            make no guarantees regarding the accuracy, currency, suitability, or quality of any User
            Content. &nbsp;Your interactions with other Site and Service users are solely between
            you and such users. &nbsp;You agree that Company will not be responsible for any loss or
            damage incurred as the result of any such interactions. &nbsp;If there is a dispute
            between you and any Site or Service user, we are under no obligation to become involved.
          </span>
        </p>
        <p class="c0">
          <span class="c3"> 5.3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Release. </span>
          <span class="c2">
            &nbsp;You hereby release and forever discharge the Company (and our directors, officers,
            employees, contractors, affiliates, representatives, agents, successors, and assigns)
            ...
            indirectly to, the Site or Services (including any interactions with, or act or omission
            of, other Site users or any Third-Party Links &amp; Ads). &nbsp;IF YOU ARE A CALIFORNIA
        ...
        <p class="c0">
          ...
          <span>
            ...
            venture between you and Company, except and solely to the extent expressly stated in
            these Terms.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="6">
          <li class="c4 c13">
            <span class="c3">DISCLAIMERS</span>
          </li>
        </ol>
        <p class="c11">
          <span class="c2">
            THE SITE AND SERVICES ARE PROVIDED ON AN “AS-IS” AND “AS AVAILABLE” BASIS, AND COMPANY
            ...
            NON-INFRINGEMENT. &nbsp;WE (AND OUR SUPPLIERS) MAKE NO WARRANTY THAT THE SITE AND
            SERVICES WILL MEET YOUR REQUIREMENTS, WILL BE AVAILABLE ON AN UNINTERRUPTED, TIMELY,
            ...
            WITH RESPECT TO THE SITE OR SERVICES, ALL SUCH WARRANTIES ARE LIMITED IN DURATION TO
        ...
        <ol class="c12 lst-kix_list_1-0" start="7">
          <li class="c4 c13">
            <span class="c3">FURTHER DISCLAIMERS</span>
          </li>
        </ol>
        <p class="c4">
          <span class="c2">
            Without limiting the generality of Section&nbsp;6, neither Company nor its affiliates or
            licensors will have any responsibilities or liability with respect to the following: (a)
            the Services could be impacted by one or more regulatory inquiries or actions, which
            could prevent or limit the ability of Company to continue to develop or provide the
            Services, or for you and your users to use the Services, (b) Company has no obligation
            to update the Services or its underlying platforms and networks to address, mitigate, or
            remediate any security or other vulnerabilities in the Services, or such platforms or
            networks, and (c) portions of the Services or any other underlying networks and
            platforms may rest on open-source software, and there is a risk that weaknesses or bugs
            that may be introduced in the infrastructural elements of the Services or any other
            underlying networks and platforms, which may result in security vulnerabilities, data
            loss, damage, destructions, disclosure, or other compromises.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="8">
          <li class="c4 c13" id="h.lnxbz9">
            <span class="c3">LIMITATION ON LIABILITY</span>
          </li>
        </ol>
        <p class="c4">
          <span class="c2">
            ...
            TO USE, THE SITE OR SERVICES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF
            SUCH DAMAGES. &nbsp;ACCESS TO, AND USE OF, THE SITE OR SERVICES IS AT YOUR OWN
        ...
        <p class="c4">
          <span class="c2">
            ...
            ALL TIMES BE LIMITED TO A MAXIMUM OF ONE US DOLLAR (U.S. $1). THE EXISTENCE OF MORE THAN
        ...
        <ol class="c12 lst-kix_list_1-0" start="9">
          <li class="c4 c13">
            <span class="c3">CRYPTOGRAPHIC SYSTEMS</span>
          </li>
        </ol>
        <p class="c4">
          <span class="c2">
            ...
            present risks to cryptographic systems and the Services, which could result in the theft
            or loss of your property. To the extent possible, the Company intends to update the code
            underlying the Services to account for any advances in cryptography and to incorporate
            additional security measures, but does not guarantee or otherwise represent full
            security of the system. By using the Services, you acknowledge these inherent risks.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="10">
          <li class="c4 c13">
            <span class="c3">PLATFORM SECURITY</span>
          </li>
        </ol>
        <p class="c4">
          <span>
            We are an early stage platform. &nbsp;You acknowledge that applications are code subject
            to flaws and acknowledge that you are solely responsible for evaluating any available
            code provided by the Services. You further expressly acknowledge and represent that
            applications can be written maliciously or negligently, that we cannot be held liable
            for your interaction with such applications. These warnings and others later provided by
            us in no way evidence or represent an ongoing duty to alert you to all of the potential
            risks of utilizing the Site and Services.
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="11">
          <li class="c4 c13">
            <span class="c3">COPYRIGHT INFRINGEMENT</span>
          </li>
        </ol>
        <p class="c4">
          <span class="c2">
            If you believe that your copyright or the copyright of a person on whose behalf you are
            authorized to act has been infringed, please provide Company a written notice containing
            the following information: (a) an electronic or physical signature of the person
            authorized to act on behalf of the owner of the copyright or other intellectual property
            interest, (b) a description of the copyrighted work or other intellectual property that
            you claim has been infringed, and (c) a description of where the material that you claim
            is infringing is located on the Site.
          </span>
        </p>
        <p class="c7">
          <span class="c2">Company can be reached at:</span>
        </p>
        <p class="c7">
          <span>Email:</span>
          <span class="c15">
            <a
              class="c16"
              href="/cdn-cgi/l/email-protection#c4a8adb5b1a5a8adb0bd84a7abaab7a1aab7bdb7eaaaa1b0"
            >
              <span
                class="__cf_email__"
                data-cfemail="026e6b7377636e6b767b42616d6c71676c717b712c6c6776"
              >
                [email&#160;protected]
              </span>
            </a>
          ...
          <span class="c15">
            <a
              class="c16"
              href="/cdn-cgi/l/email-protection#acc2c3d8c5cfc9dfeccfc3c2dfc9c2dfd5df82c2c9d8"
            >
              <span
                class="__cf_email__"
                data-cfemail="a3cdccd7cac0c6d0e3c0cccdd0c6cdd0dad08dcdc6d7"
              >
                [email&#160;protected]
              </span>
            </a>
        ...
        <ol class="c12 lst-kix_list_1-0" start="12">
          <li class="c4 c13" id="h.35nkun2">
            <span class="c3">TERM &amp; TERMINATION</span>
          </li>
        </ol>
        <p class="c4" id="h.1ksv4uv">
          <span class="c2">
            Subject to this Section, these Terms will remain in full force and effect while you use
            the Site. &nbsp;We may suspend or terminate your rights to use the Site and Services at
            any time for any reason at our sole discretion, including for any use of the Site or
            Services in violation of these Terms. &nbsp;Upon termination of your rights under these
            Terms, your right to access and use the Site and Services will terminate immediately.
            &nbsp;You understand that any such termination may involve deletion of your User
            Content. &nbsp;Company will not have any liability whatsoever to you for any termination
            of your rights under these Terms, including for deletion of your User Content.
            &nbsp;Even after your rights under these Terms are terminated, the following provisions
            of these Terms will remain in effect: Sections ‎2.2 through ‎2.5, Sections ‎3 through 8,
            and Sections 11 through 14.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </span>
        </p>
        <ol class="c12 lst-kix_list_1-0" start="13">
          <li class="c4 c13" id="h.44sinio">
            <span class="c3">GENERAL</span>
          </li>
        </ol>
        <p class="c0" id="h.2jxsxqh">
          <span class="c3"> 13.1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Changes. </span>
          <span class="c2">
            &nbsp; These Terms are subject to occasional revision, and if we make any changes, we
            will change the Last Updated date above. &nbsp;Continued use of our Site and Services
            following such notice of such changes shall indicate your acknowledgement of such
            changes and agreement to be bound by the terms and conditions of such changes..
          </span>
        </p>
        <p class="c0" id="h.z337ya">
          <span class="c3">
            13.2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dispute Resolution.
          </span>
          <span class="c6 c3">
            Please read this Arbitration Agreement (the “Arbitration Agreement”) carefully. &nbsp;It
            is part of your contract with Company and affects your rights. &nbsp;It contains
            procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (a)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Applicability of Arbitration Agreement.</span>
          <span class="c2">
            ...
            proceedings shall be held in English. &nbsp;This Arbitration Agreement applies to you
        ...
        <p class="c4 c8">
          <span class="c3"> (b)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6"> Notice Requirement and Informal Dispute Resolution </span>
          <span>
            . &nbsp;Before either party may seek arbitration, the party must first send to the other
            party a written Notice of Dispute (
          </span>
          <span class="c3">“Notice”</span>
          <span class="c2">
            ) describing the nature and basis of the claim or dispute, and the requested relief.
            &nbsp;A Notice to the Company should be sent to: 49 Bogart St. #22, Brooklyn, New York
            11206. &nbsp;After the Notice is received, you and the Company may attempt to resolve
            the claim or dispute informally. &nbsp;If you and the Company do not resolve the claim
            or dispute within thirty (30) days after the Notice is received, either party may begin
            an arbitration proceeding. &nbsp;The amount of any settlement offer made by any party
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Arbitration Rules</span>
          <span>
            . &nbsp; This Agreement shall be governed by the laws of the State of New York. Any
            claim, dispute, or controversy (“Claim”) arising out of or relating to this Agreement or
            the relationships among the parties hereto shall be resolved by one arbitrator through
            binding arbitration conducted in accordance with the expedited procedures set forth in
            the JAMS Comprehensive Arbitration Rules and Procedures (the “Rules”) as those Rules
            exist on the effective date of this Agreement, including Rules 16.1 and 16.2 of those
            Rules. The arbitrator’s decision shall be final, binding, and non-appealable. Judgment
            upon the award may be entered and enforced in any court having jurisdiction. This clause
            is made pursuant to a transaction involving interstate commerce and shall be governed by
            the Federal Arbitration Act. Neither party shall sue the other party other than as
            provided herein or for enforcement of this clause or of the arbitrator’s award; any such
            suit may be brought only in a Federal District Court or a New York state court located
            in New York County, New York. The arbitrator, and not any federal, state, or local
            ...
            formation of this Agreement including any claim that all or any part of the Agreement is
            void or voidable.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (d)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6"> Additional Rules for Non-Appearance Based Arbitration </span>
          <span class="c2">
            . &nbsp;If non-appearance based arbitration is elected, the arbitration shall be
            conducted by telephone, online and/or based solely on written submissions; the specific
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Time Limits.</span>
          <span class="c2">
            ...
            for filing a claim) and within any deadline imposed under the Rules for the pertinent
            claim.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (f)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Authority of Arbitrator</span>
          <span class="c2">
            . &nbsp;If arbitration is initiated, the arbitrator will decide the rights and
            liabilities, if any, of you and the Company, and the dispute will not be consolidated
            ...
            have. &nbsp;The award of the arbitrator is final and binding upon you and the Company.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (g)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Waiver of Jury Trial.</span>
          <span class="c2">
            ...
            or federal court in a suit to vacate or enforce an arbitration award or otherwise, YOU
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Waiver of Class or Consolidated Actions</span>
          <span class="c2">
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Confidentiality</span>
          <span class="c2">
            . &nbsp;All aspects of the arbitration proceeding, including but not limited to the
            award of the arbitrator and compliance therewith, shall be strictly confidential.
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Severability</span>
          <span class="c2">
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Right to Waive.</span>
          <span class="c2">
            &nbsp; Any or all of the rights and limitations set forth in this Arbitration Agreement
            may be waived by the party against whom the claim is asserted. &nbsp;Such waiver shall
            not waive or affect any other portion of this Arbitration Agreement.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (l)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Survival of Agreement</span>
          <span class="c2">
        ...
        <p class="c4 c8">
          ...
          <span class="c6">Small Claims Court.</span>
          <span class="c2">
            &nbsp; Notwithstanding the foregoing, either you or the Company may bring an individual
            action in small claims court.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (n)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Emergency Equitable Relief</span>
          <span class="c2">
            . &nbsp;Notwithstanding the foregoing, either party may seek emergency equitable relief
            before a state or federal court in order to maintain the status quo pending arbitration.
            &nbsp;A request for interim measures shall not be deemed a waiver of any other rights or
            obligations under this Arbitration Agreement.
          </span>
        </p>
        <p class="c4 c8">
          <span class="c3"> (o)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Claims Not Subject to Arbitration.</span>
          <span class="c2">
        ...
        <p class="c4 c8">
          <span class="c3"> (p)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
          <span class="c6">Courts.</span>
          <span class="c2">
            ...
            jurisdiction of the courts located within Kings &nbsp;County, New York, for such purpose
          </span>
        </p>
        <p class="c0">
          <span class="c3"> 13.3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export. </span>
          <span class="c2">
        ...
        <p class="c0">
          <span class="c3"> 13.4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Disclosures. </span>
          <span class="c2">
            &nbsp; If you are a California resident, you may report complaints to the Complaint
            Assistance Unit of the Division of Consumer Product of the California Department of
            Consumer Affairs by contacting them in writing at 400 R Street, Sacramento, CA 95814, or
